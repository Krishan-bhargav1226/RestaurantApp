...
{
    Task<TableSessionResponseDto> CreateAsync(CreateUpdateTableSessionDto input);
    Task<List<TableSessionResponseDto>> GetAllAsync();
    Task<TableSessionResponseDto?> GetByIdAsync(int id);
    Task<TableSessionResponseDto?> UpdateAsync(int id, CreateUpdateTableSessionDto input);
